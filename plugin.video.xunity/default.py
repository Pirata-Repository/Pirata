...
base_url='http://xty.me/xunitytalk/skins/'
icon = 'http://xty.me/xunitytalk/addons/plugin.video.xunity/icon.png'
ifan = 'http://xty.me/xunitytalk/addons/plugin.video.xunity/fanart.jpg'
...
ISTREAMREPO='http://xty.me/xunitytalk/addons/repository.istream/repository.istream-1.0.zip'

XUNITYTALK='http://xty.me/xunitytalk/addons/repository.xunitytalk/repository.xunitytalk-1.0.3.zip'
...
def CATEGORIES():
        ...
        for name ,zip_url ,description in match:
            ...
            url_dest    =   'http://xunitytalk.com/xfinity/Skins/'+'%s/%s' %(name,zip_url)
            iconimage   =   'http://xunitytalk.com/xfinity/Skins/'+'%s/icon.png' %name
            fanart      =   'http://xunitytalk.com/xfinity/Skins/'+'%s/fanart.png' %name
